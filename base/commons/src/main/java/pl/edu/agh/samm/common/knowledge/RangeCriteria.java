 ...
 * 
 */
public class RangeCriteria implements ICriterion, Serializable {
	...
	public RangeCriteria(double thresholdOver, double thresholdUnder) {
	...
	public boolean meetsCriterion(Number value) {
		...
		return doubleValue > thresholdUnder && doubleValue < thresholdOver;
	}

	@Override
	public String toString() {
		return "Range: " + thresholdUnder + " - " + thresholdOver;
	}
}
