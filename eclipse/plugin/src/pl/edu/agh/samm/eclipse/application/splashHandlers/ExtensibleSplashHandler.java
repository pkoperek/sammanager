 ...
 * along with SAMM.  If not, see <http://www.gnu.org/licenses/>.
 */
package pl.edu.agh.samm.eclipse.application.splashHandlers;
...
public class ExtensibleSplashHandler extends AbstractSplashHandler {
	...
	private final static String F_SPLASH_EXTENSION_ID = "pl.edu.agh.samm.eclipse.application.splashExtension"; // NON-NLS-1
