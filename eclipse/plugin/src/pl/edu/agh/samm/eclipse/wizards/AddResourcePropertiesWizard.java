 ...
 * 
 */
public class AddResourcePropertiesWizard extends PropertiesPagesWizard {

	private String uri;

	public AddResourcePropertiesWizard(String resourceUri) {
	...
	public boolean performFinish() {
		try {
			SAMM.getCoreManagement().addResourceParameters(uri, getParameters());
